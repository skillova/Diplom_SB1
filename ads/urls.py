...
urlpatterns = [
    path('ad_list/', AdListAPIView.as_view(), name='ad-list'),
    path('ad_create/', AdCreateAPIView.as_view(), name='ad-create'),
    path('mylist/', MyAdListAPIView.as_view(), name='ad-mylist'),
    path('ad/<int:pk>/', AdRetrieveAPIView.as_view(), name='ad-detail'),
    path('ad/<int:pk>/update/', AdUpdateAPIView.as_view(), name='ad-update'),
